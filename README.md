# genpark-waterfall-b2b-prospect-enrichment-gtm-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Waterfall B2B prospect data enrichment and outbound GTM orchestrator (Clay style)
